  ...
  return (
    <div style={{ backgroundColor: "var(--bg-primary)" }}>
      ...
      <div aria-hidden="true" style={{ position: "absolute", width: "1px", height: "1px", overflow: "hidden", clip: "rect(0,0,0,0)", whiteSpace: "nowrap" }}>
        ...
        <p>Разрабатываем умных AI агентов и ИИ ассистентов на базе ChatGPT, Claude AI, Gemini. Чат-боты для Telegram и WhatsApp. Нейросотрудники и виртуальные продавцы под ключ. Автоматизация на Make.com, n8n, Zapier.</p>
        <h3>Автоматизация бизнеса с помощью нейросетей</h3>
        <p>Автоматизация продаж, лидогенерации и обработки заявок. AI продавцы и нейро ассистенты для интернет-магазинов, агентств и сервисов. Разработка на Next.js, React Native, Python. Интеграция с CRM, Bitrix24, amoCRM.</p>
      </div>
